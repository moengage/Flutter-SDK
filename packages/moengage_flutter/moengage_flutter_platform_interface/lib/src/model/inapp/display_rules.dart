...
class Rules {
  ...
  Rules(
      {@Deprecated(
          'This parameter is deprecated and will be removed in future releases. Use [screenNames] instead')
      this.screenName,
      List<String>? context,
  ...
  @Deprecated(
      'This field is deprecated and will be removed in future releases. Use [screenNames] instead')
  String? screenName;
