...
void main() {
  group('StaticImageType', () {
    test('fromString returns correct enum for valid strings', () {
      expect(StaticImageType.fromString('no_cards'), StaticImageType.emptyState);
      expect(StaticImageType.fromString('pinned_card'), StaticImageType.pinCard);
      expect(StaticImageType.fromString('place_holder'), StaticImageType.loadingPlaceHolder);
    });

    test('fromString throws ArgumentError for invalid string', () {
      expect(() => StaticImageType.fromString('invalid_value'), throwsArgumentError);
    ...
    test('toShortString returns correct string value', () {
      ...
      expect(StaticImageType.loadingPlaceHolder.toShortString(), 'place_holder');
    });
