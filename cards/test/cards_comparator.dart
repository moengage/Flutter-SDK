...
class CardsComparator {
  ...
  bool isContainersEqual(
      List<Container> containers1, List<Container> containers2) {
  ...
  bool isNavigationActionEqual(
      NavigationAction? action1, NavigationAction? action2) {
    if (action1 == action2) return true;
    if (action1 == null || action2 == null) return false;
  ...
  bool isWidgetStyleEqual(
      WidgetStyle? widgetStyle1, WidgetStyle? widgetStyle2) {
  ...
  bool isMetaDataEqual(MetaData metaData1, MetaData metaData2) {
    return metaData1.isNewCard == metaData2.isNewCard &&
        ...
        isCampaignStateEqual(
            metaData1.campaignState, metaData2.campaignState) &&
        isDisplayControlEqual(
            metaData1.displayControl, metaData2.displayControl);
  }

  bool isCampaignStateEqual(
      CampaignState campaignState1, CampaignState campaignState2) {
  ...
  bool isDisplayControlEqual(
      DisplayControl displayControl1, DisplayControl displayControl2) {
  ...
  bool isSyncDataEquals(
      SyncCompleteData syncCompleteData1, SyncCompleteData syncCompleteData2) {
