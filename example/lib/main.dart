...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    _moengagePlugin.setElementTooltipRenderMode(TooltipRenderMode.nativeOverlay);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      navigatorObservers: <NavigatorObserver>[MoENavigationObserver()],
            ...
            child: ListView(
              children: ListTile.divideTiles(context: context, tiles: [
                ListTile(
                  ...
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        settings: const RouteSettings(name: 'CardsHome'),
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        settings: const RouteSettings(name: 'InAppHomeScreen'),
                ...
                ListTile(
                    ...
                    onTap: () async {
                      ...
                      details
                          ...
                          .addAttribute(
                              'location1', MoEGeoLocation(12.1, 77.18))
                          .addAttribute(
                              'location2', MoEGeoLocation(12.2, 77.28))
                          .addAttribute(
                              'location3', MoEGeoLocation(12.3, 77.38))
                          .addISODateTime(
                              'dateTime1', '2019-12-02T08:26:21.170Z')
                          .addISODateTime(
                ...
                ListTile(
                    title:
                        const Text('Track Interactive Event with Attributes'),
                    onTap: () async {
                      MoEProperties details = MoEProperties();
                      details
                          .addAttribute('temp', 567)
...
//                    _moengagePlugin.setUniqueId(null);
                ...
                ListTile(
                  ...
                  onTap: () async {
                    final String value =
                        await asyncInputDialog(context, 'Alias');
